...
public class TransformType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "XPath", namespace = "http://www.bull.com/metasign/xmlSignaturePolicy/v3.1#", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "XSLT", namespace = "http://www.bull.com/metasign/xmlSignaturePolicy/v3.1#", type = JAXBElement.class, required = false)
    })
    @XmlMixed
